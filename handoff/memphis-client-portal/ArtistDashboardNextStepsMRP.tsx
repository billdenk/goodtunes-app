                        ...
                        {s.id === 'assets' && (
                          <div style={{ marginTop: 11, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                            ...
                            <button
                              ...
                              style={{ padding: '9px 20px', borderRadius: 0, border: 'none', cursor: 'pointer', background: BLUE, color: INK, fontSize: 12.5, fontWeight: 700 }}
                            >
          ...
          <div style={{ marginTop: 20, display: 'grid', gridTemplateColumns: '1fr', gap: 14 }}>
            ...
            <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20 }}>
              ...
              <div style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: 13 }}>
                ...
                <img src={californialandCover} alt={`${MOCK_JOB} cover art`} style={{ width: 40, height: 40, borderRadius: 0, objectFit: 'cover', border: `1px solid ${HAIRLINE}` }} />
                <div style={{ flex: 1 }}>
