...
const MOCK_ACTIVITY: { id: string; kind: ActivityKind; ts: string; title: string; detail: string }[] = [
  ...
  { id: 'a3', kind: 'milestone', ts: ago(120), title: 'Californialand passed 500 units', detail: 'Your best-selling project · $6,400.00 lifetime' },
...
const MOCK_TOP_PROJECTS: { id: string; title: string; format: string; units: number; salesCents: number; cover?: string }[] = [
  { id: 'customsland', title: MOCK_JOB, format: 'Vinyl LP · in production at Memphis Record Pressing', units: 0, salesCents: 0, cover: californialandCover },
  { id: 'californialand', title: 'Californialand', format: 'Vinyl LP · repress', units: 512, salesCents: 640_000 },
    ...
    <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20, height: '100%', display: 'flex', flexDirection: 'column' }} data-testid="dashboard-trend-chart">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap', marginBottom: 14 }}>
        <div style={{ fontSize: 15, fontWeight: 700 }}>
          The last 30 days. <span style={{ color: SUBINK, fontWeight: 500 }}>This period vs prior.</span>
        </div>
  ...
  return (
    <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20, height: '100%', display: 'flex', flexDirection: 'column' }} data-testid="dashboard-activity-feed">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, flexShrink: 0 }}>
        ...
        <A style={{ fontSize: 12.5, color: LINK, fontWeight: 600 }} data-testid="link-activity-view-all">View all</A>
      </div>
  ...
  return (
    <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20, height: '100%', display: 'flex', flexDirection: 'column' }} data-testid="dashboard-top-projects">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10, flexShrink: 0 }}>
        ...
        <A style={{ fontSize: 12.5, color: LINK, fontWeight: 600 }} data-testid="link-projects-view-all">View all</A>
      </div>
  ...
  return (
    <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20 }} data-testid="dashboard-sales-channels">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
        ...
        <A style={{ fontSize: 12.5, color: LINK, fontWeight: 600 }} data-testid="link-channels-view-all">View all</A>
      </div>
  ...
  return (
    <div style={{ borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, padding: 20 }} data-testid="dashboard-giving">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
        ...
        <A style={{ fontSize: 12.5, color: LINK, fontWeight: 600 }} data-testid="link-giving-view-impact">View impact</A>
      </div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div style={{ minWidth: 0 }}>
          <div style={{ fontSize: 12.5, fontWeight: 500, lineHeight: 1.45 }}>Supporting Endometriosis Foundation of America</div>
          <div style={{ fontSize: 11.5, color: SUBINK, marginTop: 2 }}>
            <span style={{ fontWeight: 600, color: INK, fontVariantNumeric: 'tabular-nums' }}>$486.00</span> raised from your sales · via GoodDeed®
          </div>
        </div>
      </div>
    </div>
        ...
        <main style={{ flex: 1, minWidth: 0, overflowY: 'auto' }}>
          <div style={{ maxWidth: 1180, margin: '0 auto', padding: '28px 28px 60px' }}>
            ...
            <section style={{ marginTop: 22, borderRadius: 0, background: CARD, border: `1px solid ${HAIRLINE}`, overflow: 'hidden' }} data-testid="next-steps-strip">
              ...
              >
                <img src={californialandCover} alt="" aria-hidden style={{ width: 30, height: 30, borderRadius: 0, objectFit: 'cover', border: `1px solid ${HAIRLINE}` }} />
                <span style={{ fontSize: 13.5, fontWeight: 700 }}>Next steps — {MOCK_JOB}.</span>
                          ...
                          {s.id === 'assets' && (
                            <div style={{ marginTop: 11, display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                              ...
                              <button
                                ...
                                style={{ padding: '9px 20px', borderRadius: 0, border: 'none', cursor: 'pointer', background: GOLD, color: INK, fontSize: 12.5, fontWeight: 700, fontFamily: FONT }}
                              >
