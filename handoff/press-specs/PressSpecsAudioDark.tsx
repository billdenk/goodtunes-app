// PressSpecsAudioDark — the Specs → Audio page a press like Memphis Record
// Pressing would actually fill in. Format-aware: Vinyl, CD, and Cassette have
// genuinely different audio requirements, so the segmented control switches
// the whole field set. The "digital vs physical" question resolves as: the
// press only sets specs for the *master files* they accept (digital inputs)
// per physical format — no separate digital tab needed.
//
