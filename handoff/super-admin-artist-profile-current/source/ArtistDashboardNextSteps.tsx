...
export function ArtistDashboardNextStepsStrip({ onUploadFiles }: { onUploadFiles?: () => void }) {
  ...
  return (
    <section style={{ borderRadius: 14, background: CARD, border: `1px solid ${HAIRLINE}`, overflow: 'hidden', color: INK }} data-testid="next-steps-strip">
      <button
        type="button"
      ...
      {open && <div style={{ borderTop: `1px solid ${HAIRLINE}` }}>
