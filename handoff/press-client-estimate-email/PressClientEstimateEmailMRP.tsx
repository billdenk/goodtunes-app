...
// #D6A63F (the quote builder's PRESS_ACCENT) replaces GoodTunes blue, and
...
const GOLD = '#D6A63F'; // MRP white-label accent (same PRESS_ACCENT as the quote builder)
const GOLD_TINT_TOP = 'rgba(214,166,63,0.12)';
