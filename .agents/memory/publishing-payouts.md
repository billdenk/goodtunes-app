...
- The current statutory rate is a single setting (`payout_settings.mechanical_rate_micros`, 131000 = $0.131 as of September 2, 2026) passed through as `rateMicros`; historical settlement inputs may retain older rates. Never hard-code dollar amounts: the engine is data-driven off splits × units × rate.
