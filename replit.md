...
- **[docs/sales/investor-overview.md](./docs/sales/investor-overview.md)** — investor-ready overview Bill sends to partners and labels; keep current whenever a capability ships.
