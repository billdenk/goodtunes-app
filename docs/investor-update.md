...
- **LyricFlow™ synced lyrics.** Lyrics scroll in time with the song in an Apple-Music-style overlay, with the active line in focus and surrounding lines softly blurred; tapping any line seeks the song to that lyric. The chorus finder can snap the 30-second preview window to the song's hook automatically.
