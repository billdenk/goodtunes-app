  ...
  if (items.length === 0) {
    return (
      ...
      >
        ...
        >
          <CheckCircle2 className="w-6 h-6" style={{ color: '#1c8a5b' }} />
        </span>
        <h3 className="mt-4 text-[18px] font-semibold" style={{ color: INK }}>
          You're all caught up
        </h3>
        <p className="mt-1.5 text-[13.5px] max-w-sm leading-relaxed" style={{ color: SUBINK }}>
