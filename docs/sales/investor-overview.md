...
- **Apple-Music-grade player** — animated equalizer, LyricFlow™ scrolling lyrics, tap-any-line seek, full-screen lyric overlay
...
- **LyricFlow™ synced lyrics** — ElevenLabs transcribes and aligns word-by-word; a chorus finder snaps previews to the hook automatically
