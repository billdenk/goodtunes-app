...
function GrantStatusPill({ status }: { status: PreviewGrant["status"] }) {
  const map = {
    active: { cls: "bg-emerald-100 text-emerald-800", label: "Active", icon: CheckCircle2 },
    expired: { cls: "bg-slate-100 text-slate-500", label: "Expired", icon: Clock3 },
    revoked: { cls: "bg-rose-100 text-rose-700", label: "Revoked", icon: Ban },
  } as const;
  const m = map[status];
...
function PreviewGrantRevokeRow({
  ...
  return (
    <div
      className="flex items-start justify-between gap-3 rounded-lg border border-[color:var(--apple-hairline)] bg-[color:var(--apple-card)] p-2.5"
...
export function AccessWithoutPurchaseSection({
  ...
  return (
    <div
      className="rounded-xl border border-[color:var(--apple-hairline)] bg-[color:var(--apple-card)] overflow-hidden"
      ...
      <div className="flex items-start justify-between gap-4 px-5 py-3.5 border-b border-slate-100">
        ...
        {onManagePreview && (
          <button
            ...
            className="shrink-0 inline-flex items-center gap-1 text-xs font-medium text-[color:var(--brand-blue)] transition-opacity hover:opacity-75"
                ...
                >
                  <div className="min-w-0">
                    <div className="flex items-center gap-1.5">
                      ...
                      {o.kind === "comp" ? (
                        <span
                          className="inline-flex items-center gap-1 rounded-full border border-[color:var(--apple-hairline)] bg-[color:var(--apple-track)] px-2 py-0.5 text-xs font-semibold text-[color:var(--apple-ink)]"
