                ...
                <div className="flex items-center gap-2.5">
                  <div
                    className={cn(
                      ...
                      overBudget ? "text-amber-800" : "text-slate-500",
                    )}
                  ...
                  {ids.map((id, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="w-6 text-center text-[13px] tabular-nums text-slate-400">
                          {i + 1}
                        </div>
                        <div className="flex-1 min-w-0 text-sm text-slate-900 truncate">
                          <span
                            className="mr-1.5 tabular-nums text-[13px] text-slate-400 font-medium"
