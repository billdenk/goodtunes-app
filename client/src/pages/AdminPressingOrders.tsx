...
import { CheckCircle2, XCircle, Clock, Factory } from "lucide-react";
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 text-[14px] font-semibold text-slate-900">
                        <Link
                          ...
                          className="text-inherit hover:text-[var(--brand-blue)] hover:underline"
                      ...
                      <div className="mt-2 grid grid-cols-2 sm:grid-cols-4 gap-x-6 gap-y-1.5 text-[12.5px]">
