...
// Layer eligibility (shared, Tasks #3306/#3307): only GT template layers
// become toggle chips — GT-prefixed names or LINE/AREA overlay layers. The
// press live-test page has always filtered with exactly this predicate; the
// artist test page reuses it, and the server's clean "design template"
// download hides exactly this same set. ONE definition, in @shared.
export { isGtEligibleLayer } from '@shared/gtLayerNames';
